...
function abrirChat() {
  window.dispatchEvent(new Event('abrir-chat-ricardo'))
}

/**
 * Empujones de conversión, pensados para tráfico de anuncios en celular (78% del tráfico):
 * barra fija inferior en móvil con el chat de Ricardo + "Prueba 14 días gratis", visible tras
 * pasar el hero — el CTA nunca queda a 4 pantallas de distancia. (En desktop, el lanzador
 * flotante del chat lo pone ChatRicardo.)
 */
    ...
    >
      <div className="flex items-center gap-2">
        <button
          ...
          className="flex h-11 w-11 shrink-0 items-center justify-center rounded-full border border-orange-300 bg-orange-50 text-orange-600"
        >
      ...
      <Reveal className="mt-10">
        <div className="rounded-3xl border border-orange-200 bg-gradient-to-br from-orange-50 to-white p-8 text-center">
          ...
          <div className="mt-5 flex flex-col items-center justify-center gap-3 sm:flex-row">
            ...
            >
              <MessageCircle className="h-4 w-4 text-orange-600" /> ¿Dudas? Pregúntale a Ricardo
            </button>
          </div>
          <p className="mt-3 text-xs text-muted-foreground">Te contesta al momento, sin compromiso.</p>
        </div>
      </Reveal>
    </section>
  )
